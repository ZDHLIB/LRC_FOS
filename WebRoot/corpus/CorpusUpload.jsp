...
<body>
<form action="<%=request.getContextPath()%>/corpus/UserUpload?method=uploadCourpus" method="post" enctype="multipart/form-data" name="corpusUploadForm" id="corpusUploadForm" onSubmit="return(FormCheck())">
  <table width="582" border="0">
    ...
    <tr>
      ...
      <td><input type="radio" name="origin" id="origin" value="网络媒体" checked>网络媒体</input>
       <label>
        <select name="net">
      	<option selected="selected" value="中心网站">中心网站</option>
				<%        
      ...
      <input type="radio" name="origin" id="origin" value="纸质媒体">纸质媒体</input>
          <label>
        <select name="paper">
      	<option selected="selected" value="新疆报">新疆报</option>
				<%        
      ...
      <label>
      <input type="radio" name = "origin" id = "origin" value = "人工语料">人工</input>
      </label>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>标题：</td>
      <td><label>
        <input name="title" type="text" id="title" size="40" maxlength="40"/>
      </label></td>
    </tr>
    <tr>
      <td>作者：</td>
    ...
    <tr>
      ...
      <td><label>
        ...
        <input type="reset" name="cancel" id="cancel" value="取消" onclick="window.close();"/>
      </label></td>
    </tr>
  </table>
</form>
