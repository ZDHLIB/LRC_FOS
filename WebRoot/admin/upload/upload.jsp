<%@ page contentType="text/html;charset=utf-8" language="java" import="net.lrc.model.*,java.util.*,net.lrc.model.ResourceKind" %>
...
<body>
<form name="form1" method="post" action="resource.do?method=add&language=china" enctype="multipart/form-data">
