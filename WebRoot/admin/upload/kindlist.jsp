		...
		<table width="95%" border="0" cellspacing="1" cellpadding="3" align="center" class="tableBorder">
			...
			<tr>
				<td height="30" class="forumrow">
					<center>
						<a href="<%=request.getContextPath()%>/admin/upload/resourceKind.jsp"><u>增加种类</u></a>
					</center>
				</td>
			</tr>
		</table>
		...
		<table width="95%" border="0" cellspacing="1" cellpadding="3" align="center" class="tableBorder">
			...
			<tr>
				<td width="20%" height=25 class="forumRow">
					<center>
						<a href="resource.do?method=getResource&language=china&id=<%=kind.getKind_id()%>"><%=kind.getKind_name()%></a>
					</center>
				</td>
				...
				<td width="30%" class="forumRow">
					<center>
						<a href="resource.do?method=showkind&language=china&id=<%=kind.getKind_id()%>">编辑</a> |
						<a href="resource.do?method=deletekind&language=china&id=<%=kind.getKind_id()%>" onClick="if(confirm('是否删除此条资源种类？')){return(true);}else{return(false);}"><font color="#ff0000">删除</font></a>
					</center>
				</td>
			</tr>
			<%
