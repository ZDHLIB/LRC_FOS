...
<center>   
 <form action="user.do?method=add" method="post" name="form1" id="form1" onsubmit="return this.validateSubmit()"> 
                        ...
                        <td>
                            <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 6">
                              ...
                              <tr> 
                                ...
                                <td height="25" align="left"><input style="FONT-SIZE: 12px;" type="password" id="password" name="password" size="25" class=input validation="Empty"/><font color="#ff000">*</font></td>
                              </tr>
                              <tr> 
                                <td height="25" align="left">密码确认</td>
                                <td height="25" align="left"><input onblur="check(this)" style="FONT-SIZE: 12px;" type="password" id="password2" name="password2" size="25" class=input validation="Empty"/><font color="#ff000">*</font></td>
                              </tr>
                              <tr> 
...
&nbsp;<font color="#ff000">*</font></td>
                        ...
                        <td height="25" align="left"><select name="departmentId">
