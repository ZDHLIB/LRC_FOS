...
<html>
	...
	<body>
		<table width = "95%" border = "0"  cellspacing = "1"  cellpadding = "3"
			...
			<tr>
				<th height = "24"  closan="1">
					<input type="radio" name="quality" id="quality" value="0" onclick="location.replace('Corpus0Test.jsp')">无</input> 
					<input type="radio" name="quality" id="quality" value="1" onclick="location.replace('Corpus1Test.jsp')">低</input>
					<input type="radio" name="quality" id="quality" value="2" onclick="location.replace('Corpus2Test.jsp')" checked>中</input>
					<input type="radio" name="quality" id="quality" value="2" onclick="location.replace('Corpus3Test.jsp')">高</input>
				</th>
			</tr>
			<tr>
				<th height = "24"  closan="1">文件类型：
					<input type="radio" name="type" id="type" value="All" onclick="location.replace('Corpus2Test.jsp')" checked>All</input>
					<input type="radio" name="type" id="type" value=".doc" onclick="location.replace('Corpus2Test_doc.jsp')">.doc</input>
					<input type="radio" name="type" id="type" value=".txt" onclick="location.replace('Corpus2Test_txt.jsp')" > .txt</input>
					<input type="radio" name="type" id="type" value=".xml" onclick="location.replace('Corpus2Test_xml.jsp')"> .xml</input>
					<input type="radio" name="type" id="type" value=".pdf" onclick="location.replace('Corpus2Test_pdf.jsp')"> .pdf</input>
				</th>
			</tr>
		</table>
		<table width="95%" border="0" cellspacing="1" cellpadding="3"
			...
			//	String type = request.getParameter("type");
				...
				if (corpusList != null) {
					...
					while (i.hasNext()) {
						...
						//tempType = tempCorpusBean.getType_tag();					
						n++;
