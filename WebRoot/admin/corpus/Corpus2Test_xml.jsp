		...
		<table width = "95%" border = "0"  cellspacing = "1"  cellpadding = "3"
			...
			<tr>
				<th height = "24"  closan="1">文件类型：
					<input type="radio" name="type" id="type" value="All" onclick="location.replace('Corpus2Test.jsp')">All</input>
					...
					<input type="radio" name="type" id="type" value=".xml" onclick="location.replace('Corpus2Test_xml.jsp')" checked> .xml</input>
