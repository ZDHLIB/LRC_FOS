	...
	<body>
		...
		<table width="95%" border="0" cellspacing="1" cellpadding="3"
			...
			<%						
				...
				corpusBean.setResult(offset, filepath,"temps");
				...
				if (corpusList != null) {
					...
					while (i.hasNext()) {
						...
						n++;
						if( tempCorpusBean.getCorpustag(tempCorpusBean.getId()).equals("1") ) {
							x = "是";
						} else {
							x = "否";
						}
			...
			<tr>
				...
				<td width="10%" class="forumRow">
					<center>
					    &nbsp;&nbsp;
						<a
							href="corpusServlet?method=searchResult&id=<%=tempCorpusBean.getId()%>"
							target="_black">查看
						</a> <br>
						
						<a
							href="corpusServlet?method=saveCorpus&id=<%=tempCorpusBean.getId()%>"
							target="_black">&nbsp;&nbsp;&nbsp;存库
						</a> <br>
						<a
							href="corpusServlet?method=deleteCorpusTemps&id=<%=tempCorpusBean.getId()%>"
