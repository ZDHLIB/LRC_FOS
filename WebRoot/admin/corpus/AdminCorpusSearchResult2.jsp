...
<html>
	...
	<body>
		<div align="right">
			<a href="<%=request.getContextPath()%>/admin/corpus/AdminCorpusSearch2.jsp">返回</a>
		</div>
		<br>
		<table width="95%" border="0" cellspacing="1" cellpadding="3" align="center" class="tableBorder">
			...
			<%
				...
				corpusBean.searchCorpus5(relationship,offset,filepath,category,language,date,date2,origin,title,author,factors);
		...
		<br><center>
			<form id="corpusSearchForm" name="corpusSearchForm" method="post"
				action="<%=request.getContextPath()%>/corpus/corpusServlet?method=searchCorpus6&idAll=<%=idAll%>&number=<%=nx%>">
				<table>
					<tr>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<td>
