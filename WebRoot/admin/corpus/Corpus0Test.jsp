		...
		<table width = "95%" border = "0"  cellspacing = "1"  cellpadding = "3"
			...
			<tr>
				<th height = "24"  closan="1">文件类型：
					<input type="radio" name="type" id="type" value="All" onclick="location.replace('Corpus0Test.jsp')" checked>All</input>
					<input type="radio" name="type" id="type" value=".doc" onclick="location.replace('Corpus0Text_doc.jsp')">.doc</input>
					<input type="radio" name="type" id="type" value=".txt" onclick="location.replace('Corpus0Test_txt.jsp')" > .txt</input>
