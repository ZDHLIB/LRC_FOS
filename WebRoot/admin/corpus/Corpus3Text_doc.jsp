		...
		<table width = "95%" border = "0"  cellspacing = "1"  cellpadding = "3"
			...
			<tr>
				<th height = "24"  closan="1">文件类型：
					<input type="radio" name="type" id="type" value="All" onclick="location.replace('Corpus3Test.jsp')">All</input>
					<input type="radio" name="type" id="type" value=".doc" onclick="location.replace('Corpus3Text_doc.jsp')" checked>.doc</input>
