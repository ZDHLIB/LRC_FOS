...
<html>
	...
	<body>
		<div align="right">
			<a href="<%=request.getContextPath()%>/admin/corpus/AdminCorpusSearch1.jsp">返回</a>
		</div>
		<br>
		<table width="95%" border="0" cellspacing="1" cellpadding="3" align="center" class="tableBorder">
			...
			<%
				...
				corpusBean.searchCorpus4(relationship,offset,filepath,category,language,date,date2,origin,title,author,factors);
