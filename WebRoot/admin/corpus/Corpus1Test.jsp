		...
		<table width = "95%" border = "0"  cellspacing = "1"  cellpadding = "3"
			...
			<tr>
				<th height = "24"  closan="1">
					...
					<input type="radio" name="quality" id="quality" value="1" onclick="location.replace('Corpus1Test.jsp')"checked>低</input>
			...
			<tr>
				<th height = "24"  closan="1">文件类型：
					<input type="radio" name="type" id="type" value="All" onclick="location.replace('Corpus1Test.jsp')" checked>All</input>
					<input type="radio" name="type" id="type" value=".doc" onclick="location.replace('Corpus1Test_doc.jsp')">.doc</input>
					<input type="radio" name="type" id="type" value=".txt" onclick="location.replace('Corpus1Test_txt.jsp')" > .txt</input>
					<input type="radio" name="type" id="type" value=".xml" onclick="location.replace('Corpus1Test_xml.jsp')"> .xml</input>
					<input type="radio" name="type" id="type" value=".pdf" onclick="location.replace('Corpus1Test_pdf.jsp')"> .pdf</input>
				</th>
			</tr>
		</table>
		<table width="95%" border="0" cellspacing="1" cellpadding="3"
