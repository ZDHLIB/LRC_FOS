...
<html>
	...
	<body>
		<%
			...
			{
		%>
		<form name="form1" action="resource.do?method=addkind&language=tibet" method="post">
			<table>
				<tr>
					<td>
						种类名称：
		...
		<%
			...
			{
		%>
		<form name="form2" action="resource.do?method=updatekind&language=tibet" method="post">
			<table>
				<tr>
					<td>
						种类名称：
