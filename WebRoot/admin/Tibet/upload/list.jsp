		...
		<table width="95%" border="0" cellspacing="1" cellpadding="3" align="center" class="tableBorder">
			...
			<tr>
				<td height="30" class="forumrow">
					<center>
						<a href="<%=request.getContextPath()%>/admin/Tibet/upload/upload.jsp"><u>增加上传</u></a>
					</center>
				</td>
			</tr>
		</table>
		...
		<table width="95%" border="0" cellspacing="1" cellpadding="3" align="center" class="tableBorder">
			...
			<tr>
				<td width="20%" height="25" class="forumRow">
					<a href="resource.do?method=getResource&language=tibet&id=<%=dd.getId()%>"><%=dd.getName()%></a>
				</td>
				<td width="5%" class="forumRow">
				...
				<td width="30%" class="forumRow">
					<center>
						<a href="#" onClick="javascript:window.open('resource.do?method=getResource&language=tibet&id=<%=dd.getId()%>','','width='+(screen.width/3)+',height='+(screen.availHeight/2)+',left='+(screen.width/3)+',top='+(screen.availHeight/3))">查看</a> |
						<a href="resource.do?method=updateStatus&language=tibet&id=<%=dd.getId()%>" onClick="if(confirm('是否审核通过此条资源？')){return(true);}else{return(false);}"><font color="#ff0000">审核</font></a> |
						<a href="resource.do?method=delete&language=tibet&id=<%=dd.getId()%>" onClick="if(confirm('是否删除此条资源？')){return(true);}else{return(false);}"><font color="#ff0000">删除</font></a>
					</center>
				</td>
			</tr>
			<%
