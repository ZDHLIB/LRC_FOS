...
<html>
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/swfupload/swfupload.js">
</script>
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/swfupload/handlers.js">
</script>
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/js/jquery-1.4.2.min.js">
</script>
	<body style="font-size: 18px; background-color: #a7c0c5">
		<script type="text/javascript">
var swfu;
var allPath = [];
var finalAllPath;
...
function myUploadFile() {
	...
	swfu = new SWFUpload(
			{
				upload_url : server_context
						+ "/textBookServelet?method=addTextDetail&mytext="
						+ mytext + "&finalAllPath=" + finalAllPath,
		...
		<form>
			<center>
				...
				<div id="divFileProgressContainer"
					style="width: 200; display: none;"></div>
				<div id="thumbnails">
					<table id="infoTable" border="0" width="90%"
						style="border: solid 1px #7FAAFF; background-color: #C5D9FF; padding: 2px; margin-top: 8px;">
					</table>
				</div>
				<br />
				<br />
				<input type="button" name="button1" id="button1" value="确定"
					onclick="startUpload()">
				<br />
			</center>
		</form>
