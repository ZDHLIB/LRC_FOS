...
<table width="970">
<tr bgcolor="#99CC99"><td class=tool_bar align=left height=25>
<A 
            href="<%=request.getContextPath()%>/index.jsp"><FONT 
...
<A  href="#" onclick="setContent('5','<%=n.getId()%>')"><FONT 
 ...
 <div id="content" style="max-width:970px;min-height:400px;_height:400px;background:url('<%=request.getContextPath() %>/images/logoback.jpg'); "> </div>
