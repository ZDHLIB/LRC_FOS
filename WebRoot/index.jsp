						...
						<table cellSpacing="0" cellPadding="0" width="600" border="0">
							<tr>
								<td class="index_table_2">
									<table width="240" height="32">
										<tr>
											<td vAlign="bottom" align="right" width="16">
												<img height="26" src="lingdot_files/index_triangle.jpg" width="25">
											</td>
											<td class="index_type_text_2" align="middle" width="200" bgColor="#8ca2a5">
												友情链接
											</td>
										</tr>
									</table>
							...
							<tr bgColor="#e6efe7">
								<td class="index_table_2">
									<table width="184" height="23">
										<tr>
											<td class="index_cs_1">
												<a href="#"> <img alt="服务项目一览" src="lingdot_files/index_icon_guide.gif" border="0">
													<font class="index_cs_1"
													style="padding-left: 2px; bottom: 3px; position: relative">
													<a href=http://www.muc.edu.cn>中央民族大学</a></font>													
												</a>
											</td>
										</tr>									
									</table>
